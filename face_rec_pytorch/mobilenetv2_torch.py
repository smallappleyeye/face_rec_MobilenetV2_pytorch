...
class ConvBNReLU(nn.Sequential):
    ...
    # conv2d中，不使用偏差bias
    def __init__(self, in_channel, out_channel, kernel_size=3, stride=1, groups=1, name=[]):
...
class MobileNetV2(nn.Module):
    def __init__(self, in_dims=1, num_classes=1000, alpha=1.0, round_nearest=8):
        ...
        features = []
        # conv1 layer
        features.append(ConvBNReLU(in_dims, input_channel, stride=2))
